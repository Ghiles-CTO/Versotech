...
This project is indexed by GitNexus as **Versotech** (11231 symbols, 29857 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
