...
const FIELD_LABELS: Record<string, string> = {
  ...
  address_line_2: 'Address (Optional)',
  ...
  registered_address_2: 'Address (Optional)',
  registered_address_line_1: 'Address',
  registered_address_line_2: 'Address (Optional)',
...
const ENTITY_INFO_SECTIONS: SectionDef[] = [
  ...
  },
  {
    ...
    icon: MapPin,
    accent: { bg: 'bg-teal-500/10', text: 'text-teal-500', border: 'border-teal-500/30', num: 'bg-teal-500' },
    fields: ['registered_address', 'registered_address_2', 'registered_city', 'registered_state', 'registered_postal_code', 'registered_country'],
  },
]
