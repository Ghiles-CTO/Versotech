...
interface ConfirmCommercialPartnerPaymentModalProps {
  open: boolean
  onOpenChange: (open: boolean) => void
  commission: CommercialPartnerCommission | null
  onSuccess?: () => void
}

export function ConfirmCommercialPartnerPaymentModal({
  open,
  onOpenChange,
  commission,
  onSuccess,
}: ConfirmCommercialPartnerPaymentModalProps) {
  ...
  const handleConfirm = async () => {
    ...
    try {
      const response = await fetch(
        `/api/lawyers/me/commercial-partner-commissions/${commission.id}/confirm-payment`,
        {
          method: 'POST',
      ...
      console.error('[ConfirmCommercialPartnerPaymentModal] Error:', error)
    ...
    <>
        ...
        <DialogContent className="sm:max-w-[500px]">
          <DialogHeader>
            <DialogTitle className="flex items-center gap-2">
              ...
              Confirm Commercial Partner Payment
            </DialogTitle>
            <DialogDescription>
              Confirm that payment has been made to the commercial partner. This will update the
          ...
          <div className="space-y-4 py-4">
            <div className="rounded-lg bg-muted p-4 space-y-3">
              <div className="flex justify-between items-center">
                <span className="text-sm text-muted-foreground">Commercial Partner:</span>
                <span className="font-medium">{commission.commercial_partner_name}</span>
              </div>
            ...
            <div className="space-y-2">
              <Label htmlFor="commercialPartnerBankReference">Bank Reference (Optional)</Label>
              <Input
                id="commercialPartnerBankReference"
            ...
            <div className="space-y-2">
              <Label htmlFor="commercialPartnerPaymentDate">Payment Date (Optional)</Label>
              <Input
                id="commercialPartnerPaymentDate"
                type="date"
                value={paymentDate}
            ...
            <div className="space-y-2">
              <Label htmlFor="commercialPartnerNotes">Notes (Optional)</Label>
              <Textarea
                id="commercialPartnerNotes"
            ...
            <div className="flex items-start gap-2 p-3 bg-blue-50 border border-blue-200 rounded-lg text-blue-800 text-sm">
              ...
              <div>
                ...
                <ul className="list-disc list-inside mt-1 text-xs">
                  ...
                  <li>Commercial partner (payment received)</li>
      ...
      {commission.invoice_id && (
        <DocumentViewer
          ...
          documentName={`Invoice - ${commission.commercial_partner_name}`}
