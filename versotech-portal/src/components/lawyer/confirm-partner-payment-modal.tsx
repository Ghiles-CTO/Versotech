...
interface ConfirmPartnerPaymentModalProps {
  open: boolean
...
export function ConfirmPartnerPaymentModal({
  open,
  onOpenChange,
  commission,
  onSuccess,
}: ConfirmPartnerPaymentModalProps) {
  ...
  const handleConfirm = async () => {
    ...
    try {
      const response = await fetch(
        `/api/lawyers/me/partner-commissions/${commission.id}/confirm-payment`,
        {
          method: 'POST',
      ...
      console.error('[ConfirmPartnerPaymentModal] Error:', error)
    ...
    <>
      <Dialog open={open} onOpenChange={handleClose}>
        <DialogContent className="sm:max-w-[500px]">
          <DialogHeader>
            ...
            <DialogDescription>
              Confirm that payment has been made to the partner. This will update the
          ...
          <div className="space-y-4 py-4">
            <div className="rounded-lg bg-muted p-4 space-y-3">
              <div className="flex justify-between items-center">
                ...
                <span className="font-medium">{commission.partner_name}</span>
              </div>
            ...
            <div className="space-y-2">
              <Label htmlFor="partnerBankReference">Bank Reference (Optional)</Label>
              <Input
                id="partnerBankReference"
            ...
            <div className="space-y-2">
              <Label htmlFor="partnerPaymentDate">Payment Date (Optional)</Label>
              <Input
                id="partnerPaymentDate"
                type="date"
                value={paymentDate}
            ...
            <div className="space-y-2">
              <Label htmlFor="partnerNotes">Notes (Optional)</Label>
              <Textarea
                id="partnerNotes"
            ...
            <div className="flex items-start gap-2 p-3 bg-blue-50 border border-blue-200 rounded-lg text-blue-800 text-sm">
              ...
              <div>
                ...
                <ul className="list-disc list-inside mt-1 text-xs">
                  ...
                  <li>Partner (payment received)</li>
      ...
      {commission.invoice_id && (
        <DocumentViewer
          ...
          documentName={`Invoice - ${commission.partner_name}`}
