...
import { CleanPortfolioDashboard } from '@/components/holdings/clean-portfolio-dashboard'
import { ModernHoldingsFilters, type FiltersState, type SortOption } from '@/components/holdings/modern-holdings-filters'
import { CleanVehicleCard } from '@/components/holdings/clean-vehicle-card'
...
interface CleanHoldingsPageProps {
  initialData?: {
    kpis: any
    trends?: any
    summary: any
...
export function CleanHoldingsPage({ initialData }: CleanHoldingsPageProps) {
  // State management
            ...
            {totalResults === 0 ? (
              ...
              <div className={cn(
                ...
                {filteredHoldings.map((holding) => (
                  <CleanVehicleCard key={holding.id} holding={holding} />
                ))}
              </div>
            )}
          </div>
