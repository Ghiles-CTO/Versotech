          ...
          <Table>
            <TableHeader>
              <TableRow className="border-border hover:bg-transparent">
                <TableHead className="text-foreground bg-card">
                  <Button
                    variant="ghost"
                    onClick={() => handleSort('vehicle_name')}
                    className="hover:bg-muted text-foreground font-semibold"
                  >
                ...
                <TableHead className="text-foreground bg-card text-right">
                  <Button
                    variant="ghost"
                ...
                <TableHead className="text-foreground bg-card">Period</TableHead>
                <TableHead className="text-foreground bg-card">Status</TableHead>
                <TableHead className="text-foreground bg-card text-center">Actions</TableHead>
              </TableRow>
            </TableHeader>
            <TableBody>
