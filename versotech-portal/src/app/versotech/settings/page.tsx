...
import { User, Mail, Shield, Bell, Globe, Database, Key } from 'lucide-react'
...
export default function SettingsPage() {
  ...
  const isAdmin = profile.role === 'staff_admin'
          ...
          <CardContent className="space-y-4">
            ...
            <div className="flex items-center justify-between pt-4">
              <div className="space-y-1">
                <Label>Staff Role & Title</Label>
                <div className="flex items-center space-x-2">
                  <Badge variant="outline" className="capitalize">
                    {profile.role.replace('staff_', '').replace('_', ' ')}
                  </Badge>
                  {profile.title && (
          ...
          <CardContent className="space-y-4">
            <div className="space-y-2">
              ...
              <div className="flex items-center justify-between text-sm">
                ...
                <Badge variant="outline" className={isAdmin ? "text-purple-700 border-purple-300" : ""}>
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <div className="space-y-1">
                  ...
                  <p className="text-sm text-gray-500">
                    Receive email notifications for workflow updates and requests
                  </p>
                </div>
                <Switch
              ...
              <div className="flex items-center justify-between">
                <div className="space-y-1">
                  ...
                  <p className="text-sm text-gray-500">
                    Get notified about system events and operational issues
                  </p>
                </div>
                <Switch
                  id="system-alerts"
              ...
              {isAdmin && (
                <>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="space-y-1">
                      <Label htmlFor="audit-logs">Audit Log Notifications</Label>
                      <p className="text-sm text-gray-500">
