...
/**
 * GET /api/investors/me/notice-contacts
 * Fetch all notice contacts for the current investor entity
 */
...
export async function POST(request: Request) {
  ...
  try {
    ...
    console.error('Unexpected error in POST /api/investors/me/notice-contacts:', error)
    return NextResponse.json({ error: 'Internal server error' }, { status: 500 })
  }
}
