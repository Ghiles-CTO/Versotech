/**
 * Partner Entity Member API (Individual)
 * GET /api/partners/me/members/[memberId] - Get member details
 * PATCH /api/partners/me/members/[memberId] - Update member
 * DELETE /api/partners/me/members/[memberId] - Soft-delete member
 */
...
/**
 * GET /api/partners/me/members/[memberId]
 */
...
/**
 * PATCH /api/partners/me/members/[memberId]
 */
...
export async function DELETE(request: Request, { params }: RouteParams) {
  ...
  try {
    ...
    if (deleteError) {
      console.error('Error deleting partner member:', deleteError)
