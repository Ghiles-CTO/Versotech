/**
 * Commercial Partner Entity Member API (Individual)
 * GET /api/commercial-partners/me/members/[memberId] - Get member details
 * PATCH /api/commercial-partners/me/members/[memberId] - Update member
 * DELETE /api/commercial-partners/me/members/[memberId] - Soft-delete member
 */
...
export async function PATCH(request: Request, { params }: RouteParams) {
  ...
  try {
    ...
    if (updateError) {
      console.error('Error updating commercial partner member:', updateError)
...
export async function DELETE(request: Request, { params }: RouteParams) {
  ...
  try {
    ...
    if (deleteError) {
      console.error('Error deleting commercial partner member:', deleteError)
