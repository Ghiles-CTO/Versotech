...
const DEFAULT_ENTITY_SNAPSHOT_FIELDS: FieldSpec[] = [
  ...
  { key: 'address', label: 'Address', candidates: ['address', 'address_line_1', 'street_address', 'registered_address', 'registered_address_line_1'] },
  { key: 'address_2', label: 'Address (Optional)', candidates: ['address_2', 'address_line_2', 'registered_address_2', 'registered_address_line_2'] },
  ...
  { key: 'registered_address', label: 'Registered Address', candidates: ['registered_address', 'registered_address_line_1', 'address', 'address_line_1', 'street_address'] },
  { key: 'registered_address_2', label: 'Registered Address (Optional)', candidates: ['registered_address_2', 'registered_address_line_2', 'address_2', 'address_line_2'] },
