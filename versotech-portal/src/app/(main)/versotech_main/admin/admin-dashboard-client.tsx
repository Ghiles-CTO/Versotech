...
import { FinancialOverview } from '@/app/(staff)/versotech/staff/admin/components/financial-overview'
import { StaffManagementPanel } from '@/app/(staff)/versotech/staff/admin/components/staff-management-panel'
import { RealTimeActivityFeed } from '@/app/(staff)/versotech/staff/admin/components/real-time-activity-feed'
import { UserAccountManagement } from '@/app/(staff)/versotech/staff/admin/components/user-account-management'
import { DataExportPanel } from '@/app/(staff)/versotech/staff/admin/components/data-export-panel'
import { WorkflowMonitoring } from '@/app/(staff)/versotech/staff/admin/components/workflow-monitoring'
import { ComplianceAlertsPanel } from '@/app/(staff)/versotech/staff/admin/components/compliance-alerts-panel'
import { AdminKpiCards } from '@/app/(staff)/versotech/staff/admin/components/admin-kpi-cards'
import { StaffActivityChart } from '@/app/(staff)/versotech/staff/admin/components/staff-activity-chart'
import { ApprovalQueueChart } from '@/app/(staff)/versotech/staff/admin/components/approval-queue-chart'
import { WorkflowTrendChart } from '@/app/(staff)/versotech/staff/admin/components/workflow-trend-chart'
