  ...
  return (
    <ArrangerProfileClient
      ...
      arrangerInfo={arranger ? {
        ...
        address_line_1: arranger.address_line_1,
        address_line_2: arranger.address_line_2,
        city: arranger.city,
        state_province: arranger.state_province,
        postal_code: arranger.postal_code,
        country: arranger.country,
        website: arranger.website,
