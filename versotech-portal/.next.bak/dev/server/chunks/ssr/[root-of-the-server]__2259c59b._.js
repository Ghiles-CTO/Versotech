...
async function CreateDealPage() {
    ...
    const { data: entities } = await serviceClient.from('vehicles').select('id, name, type, currency, legal_jurisdiction, formation_date, logo_url, website_url, arranger_entity_id').order('name');
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2259c59b._.js.map