...
"[project]/versotech-portal/src/app/api/staff/reconciliation/invoices/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req) {
    const profile = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$versotech$2d$portal$2f$src$2f$lib$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["requireStaffAuth"])();
    if (!profile) {
    ...
    try {
      ...
      `).order('created_at', {
        ...
        const unpaidInvoices = invoicesWithDerived.filter((i)=>[
                'sent',
                'overdue'
...
//# sourceMappingURL=%5Broot-of-the-server%5D__90ebac5f._.js.map