...
with vfd as (
  select * from jsonb_to_recordset('[{"row_num":24,"entity_code":"IN110","investor_name":"William TOYE","investor_type":"individual","currency":"ETH","commitment":15,"funded_amount":15,"shares":60000,"current_position":15000,"notes":null,"price_per_share":0.00025,"cost_per_share":0.00025,"subscription_fee_percent":0.02,"subscription_fee_amount":0.3,"performance_fee_tier1_percent":0.2,"performance_fee_tier1_threshold":null,"performance_fee_tier2_percent":null,"performance_fee_tier2_threshold":null,"spread_per_share":0,"spread_fee_amount":0,"management_fee_percent":null,"bd_fee_percent":null,"bd_fee_amount":null,"finra_fee_shares":null,"finra_fee_amount":null,"discount_rate":null,"interest_rate":null,"valuation_cap":null,"opportunity_name":"ZERO DAO","sourcing_contract_ref":null,"contract_date":"2023-06-30 00:00:00","extra_cols":["Currency","Shares","Current Position","Notes"]}]'::jsonb) as x(
    row_num int,
    entity_code text,
    investor_name text,
    investor_type text,
