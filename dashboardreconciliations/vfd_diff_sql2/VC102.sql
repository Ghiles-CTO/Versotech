...
with vfd as (
  select * from jsonb_to_recordset('[{"row_num":32,"entity_code":"VC102","investor_name":"KRISTINA & CHENG-LIN SUTKAITYTE & HSU","investor_type":"individual","currency":"USD","commitment":50000,"funded_amount":50000,"shares":50000,"current_position":50000,"notes":null,"price_per_share":1,"cost_per_share":1,"subscription_fee_percent":0,"subscription_fee_amount":0,"performance_fee_tier1_percent":0,"performance_fee_tier1_threshold":null,"performance_fee_tier2_percent":null,"performance_fee_tier2_threshold":null,"spread_per_share":0,"spread_fee_amount":0,"management_fee_percent":null,"bd_fee_percent":null,"bd_fee_amount":null,"finra_fee_shares":null,"finra_fee_amount":null,"discount_rate":null,"interest_rate":null,"valuation_cap":null,"opportunity_name":"ISDC","sourcing_contract_ref":"Convertible Notes","contract_date":"2024-11-21 00:00:00","extra_cols":["Investor Name","Currency","Shares","Current Position"]}]'::jsonb) as x(
    row_num int,
    entity_code text,
    investor_name text,
    investor_type text,
